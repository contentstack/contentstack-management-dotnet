...
namespace Contentstack.Management.Core.Unit.Tests.Core.Services.Stack
{
    ...
    public class BulkPublishServiceTest
    {
        ...
        public void Should_Throw_On_Null_Serializer()
        {
            ...
            Assert.ThrowsException<ArgumentNullException>(() => new BulkPublishService(
                null,
        ...
        {
            var details = new BulkPublishDetails();
            var service = new BulkPublishService(serializer, new Management.Core.Models.Stack(null), details);
        ...
        {
            var details = new BulkPublishDetails();
            var service = new BulkPublishService(serializer, new Management.Core.Models.Stack(null), details, isNested: true);
        ...
        public void Should_Handle_Multiple_Service_Instances()
        {
            ...
            var service1 = new BulkPublishService(serializer, new Management.Core.Models.Stack(null), details1);
            var service2 = new BulkPublishService(serializer, new Management.Core.Models.Stack(null), details2);

            Assert.IsNotNull(service1);
            Assert.IsNotNull(service2);
            Assert.AreEqual("/bulk/publish", service1.ResourcePath);
            Assert.AreEqual("/bulk/publish", service2.ResourcePath);
        }
        ...
        public void Should_Verify_Service_Type()
        {
            ...
            Assert.AreEqual(typeof(BulkPublishService), service.GetType());
        }
