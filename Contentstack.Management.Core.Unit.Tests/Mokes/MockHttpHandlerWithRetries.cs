    ...
    public class MockHttpHandlerWithRetries : IPipelineHandler
    {
        ...
        public void AddResponse(HttpStatusCode statusCode, string body = null)
        {
            _responseQueue.Enqueue((context) =>
            {
                ...
                return new ContentstackResponse(response, TestJsonSerializerOptions.CreateDefault());
            });
        }
            ...
            string apiVersion = null)
        {
            ...
            var contentstackResponse = new ContentstackResponse(defaultResponse, TestJsonSerializerOptions.CreateDefault());
