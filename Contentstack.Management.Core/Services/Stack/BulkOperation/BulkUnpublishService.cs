...
namespace Contentstack.Management.Core.Services.Stack.BulkOperation
{
    ...
    internal class BulkUnpublishService : ContentstackService
    {
        ...
        public BulkUnpublishService(JsonSerializerOptions serializerOptions, Contentstack.Management.Core.Models.Stack stack, BulkPublishDetails details, bool skipWorkflowStage = false, bool approvals = false, bool isNested = false)
