...
namespace Contentstack.Management.Core.Models
{
    public class Workflow: BaseModel<WorkflowModel>
    {
        ...
        public virtual ContentstackResponse Disable()
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, stack, $"{resourcePath}/disable");
            return stack.client.InvokeSync(service);
        }
        ...
        public virtual ContentstackResponse Enable()
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, stack, $"{resourcePath}/enable");
            return stack.client.InvokeSync(service);
        }
        ...
        public virtual ContentstackResponse GetPublishRule(string contentType, ParameterCollection collection)
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, stack, $"/workflows/content_type/{contentType}", collection: collection);
            return stack.client.InvokeSync(service);
        }
