...
namespace Contentstack.Management.Core.Models
{
    public class Webhook : BaseModel<WebhookModel>
    {
        ...
        public ContentstackResponse Executions(ParameterCollection collection = null)
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, stack, $"{resourcePath}/executions", collection: collection);
        ...
        public ContentstackResponse Retry(string executionUid)
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, stack, $"/webhooks/{executionUid}/retry", httpMethod: "POST");
            return stack.client.InvokeSync(service);
        }
        ...
        public ContentstackResponse Logs(string executionUid)
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, stack, $"/webhooks/{executionUid}/logs");
            return stack.client.InvokeSync(service);
        }
