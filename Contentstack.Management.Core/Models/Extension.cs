...
namespace Contentstack.Management.Core.Models
{
    public class Extension
    {
        ...
        public virtual ContentstackResponse Create(ExtensionModel model)
        {
            ...
            var service = new CreateUpdateService<ExtensionModel>(stack.client.SerializerOptions, stack, resourcePath, model, "extension");
            return stack.client.InvokeSync(service);
        }
        ...
        public virtual ContentstackResponse Update(ExtensionModel model)
        {
            ...
            var service = new CreateUpdateService<ExtensionModel>(stack.client.SerializerOptions, stack, resourcePath, model, "extension", "PUT");
            return stack.client.InvokeSync(service);
        }
