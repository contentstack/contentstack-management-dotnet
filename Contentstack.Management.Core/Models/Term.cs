...
namespace Contentstack.Management.Core.Models
{
    ...
    public class Term : BaseModel<TermModel>
    {
        ...
        public ContentstackResponse Ancestors(ParameterCollection collection = null)
        {
            ...
            ThrowIfUidEmpty();
            var service = new FetchDeleteService(stack, resourcePath + "/ancestors", "GET", collection);
        ...
        public ContentstackResponse Descendants(ParameterCollection collection = null)
        {
            stack.ThrowIfNotLoggedIn();
            ThrowIfUidEmpty();
            var service = new FetchDeleteService(stack, resourcePath + "/descendants", "GET", collection);
            return stack.client.InvokeSync(service);
        }
        ...
        public ContentstackResponse Move(TermMoveModel moveModel, ParameterCollection collection = null)
        {
            stack.ThrowIfNotLoggedIn();
            ThrowIfUidEmpty();
            var service = new CreateUpdateService<TermMoveModel>(stack, resourcePath + "/move", moveModel, "term", "PUT", collection);
            return stack.client.InvokeSync(service);
        }
        ...
        public ContentstackResponse Localize(TermModel model, ParameterCollection collection = null)
        {
            stack.ThrowIfNotLoggedIn();
            ThrowIfUidEmpty();
            var service = new CreateUpdateService<TermModel>(stack, resourcePath, model, "term", "POST", collection);
            return stack.client.InvokeSync(service);
        }
        ...
        public ContentstackResponse Search(string typeahead, ParameterCollection collection = null)
        {
            ...
            var service = new FetchDeleteService(stack, "/taxonomies/$all/terms", "GET", coll);
            return stack.client.InvokeSync(service);
        }
