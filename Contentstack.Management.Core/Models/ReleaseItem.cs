...
namespace Contentstack.Management.Core.Models
{
    public class ReleaseItem {
        ...
        public ContentstackResponse GetAll(ParameterCollection parameters = null)
        {
            ...
            var service = new FetchDeleteService(stack.client.SerializerOptions, this.stack, resourcePath, collection: parameters);
        ...
        public ContentstackResponse Create(ReleaseItemModel model, ParameterCollection collection = null)
        {
            ...
            var service = new CreateUpdateService<ReleaseItemModel>(stack.client.SerializerOptions, stack, resourcePath, model, "item", collection: collection);
            return stack.client.InvokeSync(service);
        }
        ...
        public ContentstackResponse CreateMultiple(List<ReleaseItemModel> models, ParameterCollection collection = null)
        {
            ...
            var service = new CreateUpdateService<List<ReleaseItemModel>>(stack.client.SerializerOptions, stack, resourcePath, models, "items", collection: collection);
            return stack.client.InvokeSync(service);
        }
        ...
        public Task<ContentstackResponse> CreateMultipleAsync(List<ReleaseItemModel> model, ParameterCollection collection = null)
        {
            ...
            var service = new CreateUpdateService<List<ReleaseItemModel>>(stack.client.SerializerOptions, stack, resourcePath, model, "items", collection: collection);
        ...
        public ContentstackResponse UpdateReleaseItem(List<string> items)
        {
            stack.ThrowIfNotLoggedIn();
            ThrowIfUidEmpty();
            var service = new CreateUpdateService<List<string>>(stack.client.SerializerOptions, stack, $"/releases/{releaseUID}/update_items", items, "items", "PUT");
            return stack.client.InvokeSync(service);
        }
        ...
        public ContentstackResponse Delete(List<ReleaseItemModel> models, ParameterCollection collection = null)
        {
            ...
            var service = new DeleteService<List<ReleaseItemModel>>(stack.client.SerializerOptions, stack, resourcePath, "items", models, collection);
            return stack.client.InvokeSync(service);
        }
