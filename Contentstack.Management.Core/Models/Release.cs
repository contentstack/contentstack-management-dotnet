...
namespace Contentstack.Management.Core.Models
{
    public class Release : BaseModel<ReleaseModel>
    {
        ...
        public ContentstackResponse Deploy(DeployModel model)
        {
            ...
            var service = new CreateUpdateService<DeployModel>(stack.client.SerializerOptions, stack, $"{resourcePath}/deploy", model, "release");
        ...
        public ContentstackResponse Clone(string name, string description)
        {
            ...
            var service = new CreateUpdateService<Dictionary<string, string>>(stack.client.SerializerOptions, stack, $"{resourcePath}/clone", model, "release");
            return stack.client.InvokeSync(service);
        }
